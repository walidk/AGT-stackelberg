...
\begin{figure}
\begin{centering}
\subfloat[SF to PA Travel Times]{\includegraphics[height=1.3in]{../../figures/presentation/NE2Link101280}}
\subfloat[POS vs. Demand]{\includegraphics[height=1.3in]{../../figures/presentation/POSNE2Link101280}}
\end{centering}
\end{figure}
...
\begin{figure}
\centering
\only<1>{\includegraphics[scale=0.25]{../../figures/presentation/optimal_stackelberg1.png}}
\only<2>{\includegraphics[scale=0.25]{../../figures/presentation/optimal_stackelberg1-1.png}}
\only<3>{\includegraphics[scale=0.25]{../../figures/presentation/optimal_stackelberg1-2.png}}
...
\begin{figure}
\centering
\only<1>{\includegraphics[scale=0.25]{../../figures/presentation/optimal_stackelberg2.png}}
\only<2>{\includegraphics[scale=0.25]{../../figures/presentation/optimal_stackelberg3.png}}
\only<3>{\includegraphics[scale=0.25]{../../figures/presentation/optimal_stackelberg3-1.png}}
\only<4>{\includegraphics[scale=0.25]{../../figures/presentation/optimal_stackelberg3-2.png}}
\only<5>{\includegraphics[scale=0.25]{../../figures/presentation/optimal_stackelberg3-3.png}}
...
\begin{figure}
\centering
\only<1>{\includegraphics[scale=0.2]{../../figures/presentation/optimal_stackelberg_proof0.png}}
\only<2>{\includegraphics[scale=0.2]{../../figures/presentation/optimal_stackelberg_proof1.png}}
\only<3->{\includegraphics[scale=0.2]{../../figures/presentation/optimal_stackelberg_proof2.png}}
...
\begin{figure}
\centering
\only<1-3>{\includegraphics[scale=0.2]{../../figures/presentation/optimal_stackelberg_proof0.png}}
\only<4>{\includegraphics[scale=0.2]{../../figures/presentation/optimal_stackelberg_proof3.png}}
